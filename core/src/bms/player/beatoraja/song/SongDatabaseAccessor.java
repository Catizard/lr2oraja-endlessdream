...
public interface SongDatabaseAccessor {
     ...
     *
     * @param sql      SQL
     * @param score    スコアデータベースのパス
     * @param scorelog スコアログデータベースのパス
     * @param info     譜面情報データベースのパス
     * @return
     */
     ...
     * データベースを更新する
     *
     * @param updatepath 更新するフォルダのパス。全更新する場合はnull
     * @param updateAll  更新の必要がないものも更新するかどうか
     */
