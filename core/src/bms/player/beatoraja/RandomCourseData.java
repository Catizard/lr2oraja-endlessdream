...
public class RandomCourseData {
    ...
    public RandomStageData[] getStage() {
        return stage;
    }

    public void setStage(RandomStageData[] stage) {
        this.stage = stage;
    }
    ...
    public void setSongDatas(SongData[] songDatas) {
    ...
    public void setConstraint(CourseData.CourseDataConstraint[] constraint) {
