...
public class IntegerPropertyFactory {
    ...
    public enum ValueType {
        ...
        currenttime_year(21, (state) -> (state.main.getCurrentTime().get(Calendar.YEAR))),
        currenttime_month(22, (state) -> (state.main.getCurrentTime().get(Calendar.MONTH) + 1)),
        currenttime_day(23, (state) -> (state.main.getCurrentTime().get(Calendar.DATE))),
        currenttime_hour(24, (state) -> (state.main.getCurrentTime().get(Calendar.HOUR_OF_DAY))),
        currenttime_minute(25, (state) -> (state.main.getCurrentTime().get(Calendar.MINUTE))),
        currenttime_saecond(26, (state) -> (state.main.getCurrentTime().get(Calendar.SECOND))),
